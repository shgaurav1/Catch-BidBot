        ...
        if(line_num == 1):
            ...
            if bidder_id in bidder_dict:
                ...
                if len(data)==1:
                    ...
                    f1.write('%s, 1, 1, %s, 1, 0, 1, 1, 1, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s\n' %(label, float(merchandise_compare[data[3]][1])/float(merchandise_compare[data[3]][0]), float(country_compare[country][1])/float(country_compare[country][0]), url_prob_score, auction_prob_score, device_prob_score, ip_prob_score, mean_bidnum, stddev_bidnum, mean_time, stddev_time, bidding_speed, num_auctions_won, bidder_id))  
                else: 
                    temp_data = []
...
#                    different_merchandise = len(set(data[3]))# <merchandise>
                    ...
                    f1.write('%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s\n'%(label, num_bids, different_auctions, merchandise_prob_score, different_devices, bidding_frequency, different_countries, different_ip, different_url, countries_prob_score, url_prob_score, auction_prob_score, device_prob_score, ip_prob_score, mean_bidnum, stddev_bidnum, mean_time, stddev_time, bidding_speed, num_auctions_won, bidder_id))
            else:
                NOT_FOUND += 1
